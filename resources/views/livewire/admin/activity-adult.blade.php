    ...
    <div class="relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
        <div class="rounded-t mb-0 px-0 border-0">
            <div class="flex flex-wrap items-center px-4 py-2">
                ...
                <h3 class="font-semibold text-base text-indigo-600">Actividades con más usuarios</h3>
                </div>
                ...
                @if ($courses->count())
                    <table class="items-center w-full bg-transparent border-collapse">
                        ...
                        <tr>
                            ...
                            <th class="px-4 bg-gray-100 dark:bg-gray-600 text-gray-500 dark:text-gray-100 align-middle border border-solid border-gray-200 dark:border-gray-500 py-2 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Adultos mayores</th>
                        ...
                        <tbody>
                            ...
                            <tr class="text-gray-700 dark:text-gray-100">
                                ...
                                <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-lg whitespace-nowrap p-2 text-indigo-700">
